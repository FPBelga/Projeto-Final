(function (n, t) {
    ...
    return {
        Toast: class {
            ...
            #e;
            constructor(t) {
                (this.#n = this.#t(t.body, "")),
                    (this.#s = this.#t(t.animation, !0)),
                    (this.#h = this.#t(t.autohide, !0)),
                    (this.#l = this.#t(t.btnClose, !0)),
                    (this.#a = this.#t(t.btnCloseWhite, !1)),
                    (this.#d = this.#t(t.className, "")),
                    (this.#r = this.#t(t.delay, 5e3)),
                    (this.#c = this.#t(t.gap, 16)),
                    (this.#o = this.#t(t.header, "")),
                    (this.#f = this.#t(t.margin, "1rem")),
                    (this.#i = this.#t(t.placement, "top-right")),
                    (this.#e = this.#i.split("-"));
                ...
                if (h instanceof HTMLDivElement) {
                    ...
                    e.forEach((l) => {
                        ...
                        this.#o !== "" && (h.querySelector(".toast-header").removeAttribute("hidden"), e[1].remove()),
                        (this.element = h);
                }
                document.body.insertAdjacentElement("afterbegin", this.element),
                    (this.bootstrapToast = new bootstrap.Toast(this.element, { animation: this.#s, autohide: this.#h, delay: this.#r })),
